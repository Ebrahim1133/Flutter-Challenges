...
import 'package:projects/Chat_app_ui_copy3/flat_widgets/flat_chat_message.dart';
import 'package:projects/Chat_app_ui_copy3/flat_widgets/flat_message_input_box.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FlatPageWrapper(
        ...
        footer: const FlatMessageInputBox(
