...
import 'package:projects/Chat_app_ui_copy3/functions/glowRemoveScrollBehaviour.dart';
...
class FlatPageWrapper extends StatelessWidget {
  ...
  const FlatPageWrapper({this.children, this.backgroundColor, this.header, this.scrollType, this.footer, this.reverseBodyList});
...
class _PageBodyWidget extends StatelessWidget {
  ...
  final Widget? footer;
  final bool? reverseBodyList;
  const _PageBodyWidget({this.children, this.header, this.scrollType, this.footer, this.reverseBodyList});
